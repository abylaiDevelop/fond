                    ...
                    <v-card-text>
                        <v-container grid-list-md>
                            <v-layout wrap>
                                ...
                                <v-flex xs12 >
                                    <v-textarea
                                        v-model="editedItem.preview_text"
                                        label="Text"
                                    ></v-textarea>
                                </v-flex>
                                <v-flex xs12 >
...
export default {
    ...
    methods: {
        initialize() {
            ...
            axios.get('/api/news').then(response=>this.allPermissions=response.data.data);
        },
        ...
        deleteItem(item) {
            ...
            axios.delete('/api/news/'+item.id).then(response=>console.log(response.data))
